21.03.24
		--DONE-- (install custom directive on hiding dropdown menus on an outside click)
		--DONE-- (add autofocus on guest.name textarea when open MyAskGuests) 
	add focus on guest.surname textarea on pressing 'enter' 
	complete v-for cycle in Navigation.vue
		--DONE-- (find out why the path to MySeatingPlan component is missing in the router)
	upload data from MyAskGuests component in MongoDB after pressing "submit" button
	develop "MyPersinification" component
22.03.2024
		--DONE-- (center the position of pressed buttons in MyAskGuests by scrolling)
...
25.03.2024
		--DONE-- (swap "saveGuest" and "deleteGuest" functions to their more advanced versions)
...
27.03.2024
		--DONE-- swap 'saveGuest' function with the one that uses .unshift() method.
...
28.03.2024
	...
	Add material icons in 'MyAskGuests' and learn how to use them.
01.04.2024
		--DONE-- change the style of buttons in 'MyAskGuests'
		--DONE-- add media inquiry for screens with width less than 375px   
03.04.2024 
		--DONE-- integrate a map in "MyPlace" component
04.04.2024
	add 2 placemarks on the map for place of marriage and reataurant
