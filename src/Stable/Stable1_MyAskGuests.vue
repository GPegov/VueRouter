...
<template>
    ...
    <div class="guestForm">
        ...
        <form class="addGuestsForm" @submit.prevent>

            <div class="inputField" ref="rows.zero">
                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                    <input v-autofocus class="inputs" v-model="storeVariables.guest.name" type="text"
                        placeholder="Имя Гостя">

                    <input class="inputs" v-model="storeVariables.guest.surname" type="text"
        ...
        <div class="askGuests">
            <div class="guestsList">
                <transition-group tag="div" name="list" mode="out-in">
                    <div class="guestItem" v-for='(guest) in storeVariables.guests' :key="guest.id">
                        <div class="guestName">
                        ...
                        <div class="removeGuestDiv">
                            <button class="removeGuestBtn" @click="storeVariables.deleteGuest(guest.id)">
                                Удалить
                            </button>
                        </div>
                    </div>
            ...
            <div class="additionalAskButtons">
                ...
                <Transition name="collapse" mode="out-in">
                    <div class="askGuestsMore" :key="1" inheritAttrs=false ref="rows.first"
                        v-show="(storeVariables.guests.length > 0)">
                        <Transition name="all" mode="out-in">
                            <div class="rowOfButtons">
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.alone }" @click="
                                ...
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.couple }" @click="
                ...
                <!-- 2nd Row of Buttins -->
                <Transition name="collapse" mode="out-in">
                    <div class="askGuestsMore" :key="2" inheritAttrs=false ref="rows.second" v-show="((storeVariables.guests.length > 0) &&
                        (storeVariables.familyProperties.alone || storeVariables.familyProperties.couple))">
                        <Transition name="all" mode="out-in">
                            <div class="rowOfButtons">
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.withChildren }" @click="storeVariables.familyProperties.withChildren = !storeVariables.familyProperties.withChildren,
                                            storeVariables.familyProperties.withoutChildren = false,
                                            storeVariables.familyProperties.onCar = false,
                                            storeVariables.familyProperties.needTransfer = false,
                                            storeVariables.familyProperties.foodDoesntMatter = false,
                                ...
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.withoutChildren }" @click="storeVariables.familyProperties.withoutChildren = !storeVariables.familyProperties.withoutChildren,
                                            storeVariables.familyProperties.withChildren = false,
                                            storeVariables.familyProperties.onCar = false,
                                            storeVariables.familyProperties.needTransfer = false,
                                            storeVariables.familyProperties.foodDoesntMatter = false,
                ...
                <!-- 3rd Row of Buttins -->
                <Transition name="collapse" mode="out-in">
                    <div class="askGuestsMore" :key="3" inheritAttrs=false ref="rows.third"
                        v-show="((storeVariables.guests.length > 0) &&
                        ...
                        <Transition name="all" mode="out-in">
                            <div class="rowOfButtons">
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.onCar }" @click="storeVariables.familyProperties.onCar = !storeVariables.familyProperties.onCar,
                                            storeVariables.familyProperties.needTransfer = false,
                                            storeVariables.familyProperties.foodDoesntMatter = false,
                                            storeVariables.familyProperties.foodMeat = false,
                                            storeVariables.familyProperties.foodFish = false
                                ...
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.needTransfer }" @click="storeVariables.familyProperties.needTransfer = !storeVariables.familyProperties.needTransfer,
                                            storeVariables.familyProperties.onCar = false,
                                            storeVariables.familyProperties.foodDoesntMatter = false,
                                            storeVariables.familyProperties.foodMeat = false,
                                            storeVariables.familyProperties.foodFish = false
                ...
                <!-- 4th Row of Buttins -->
                <Transition name="collapse" mode="out-in">
                    <div class="askGuestsMore" :key="4" inheritAttrs=false ref="rows.fourth" v-show="((storeVariables.guests.length > 0) &&
                        (storeVariables.familyProperties.onCar || storeVariables.familyProperties.needTransfer))">
                        <Transition name="all" mode="out-in">
                            <div class="rowOfButtons">
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.foodMeat }" @click="storeVariables.familyProperties.foodMeat = !storeVariables.familyProperties.foodMeat,
                                            storeVariables.familyProperties.foodFish = false
                                            ">
                                        Мясо
                                    </button>
                                ...
                                <a href="#scrollAskGuests" v-smooth-scroll v-bind="$attrs">
                                    <button class="askGuestsMoreButton"
                                        :class="{ pressed: storeVariables.familyProperties.foodFish }" @click="storeVariables.familyProperties.foodFish = !storeVariables.familyProperties.foodFish,
                                            storeVariables.familyProperties.foodMeat = false
                                            ">
                                        Рыба
                                    </button>
