...
export const usePersonification = defineStore('personification', {
    ...
    //Heading
        ...
        headingParagraphIntro_1: 'Все вы знаете их как любимых родственников, верных друзей и надёжных коллег но наступит день, и мы больше не сможем воспринимать их отдельно друг от друга!',
        headingParagraphIntro_2: 'В этот день два любящих сердца соединятся воедино, и появится новая, счастливая семья!',
        headingParagraphIntro_3: 'Они будут рады видеть Вас и Ваших спутников на своём свадебном торжестве!',
    //Ceremony
